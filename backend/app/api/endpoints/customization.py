...
async def reset_customization(
    ...
    # Buttons
    customization.button_primary_color = None  # Will use primary_color
    customization.button_text_color = '#ffffff'
    customization.button_secondary_color = None  # Will use background_secondary
    customization.button_secondary_text = '#374151'
    customization.button_border_radius = '8px'
    
    # Inputs
    customization.input_border_color = '#d1d5db'
    customization.input_focus_color = None  # Will use primary_color
    ...
    logger.info(f"Admin {admin.email} reset customization for {organization_name} - ALL fields reset to defaults")
...
async def apply_theme_preset(
    ...
    logger.info(f"Admin {admin.email} applied preset '{preset_name}' to {organization_name}")
