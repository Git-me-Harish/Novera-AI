      ...
      <div className={`min-h-screen flex items-center justify-center px-4 py-12
        ...
        <div className="max-w-md w-full">
          <div className="text-center mb-8">
            <Link to="/login" className={`inline-flex items-center text-sm mb-6
          ...
          <div className={`${darkMode ? 'bg-gray-800 border-gray-600' : 'bg-white border-gray-200'} rounded-xl shadow-lg p-8 border`}>
            <div className="text-center">
              ...
              <h2 className={`text-2xl font-bold mb-2 ${darkMode ? 'text-gray-100' : 'text-gray-900'}`}>Check Your Email</h2>
              ...
              <div className={`${darkMode ? 'bg-gray-700' : 'bg-gray-50'} rounded-lg p-4 mb-6`}>
                <p className={`${darkMode ? 'text-gray-100' : 'text-primary-600'} font-medium break-all`}>{email}</p>
              </div>

              <div className={`${darkMode ? 'bg-gray-700 border-gray-600' : 'bg-blue-50 border-blue-200'} border rounded-lg p-4 mb-6 text-left`}>
                <p className={`${darkMode ? 'text-gray-100' : 'text-blue-800'} text-sm mb-2`}>
                  <strong>What's next?</strong>
                </p>
                <ul className={`text-sm ${darkMode ? 'text-gray-300' : 'text-blue-700'} space-y-1 list-disc list-inside`}>
    ...
    <div className={`min-h-screen flex items-center justify-center px-4 py-12
      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h2 className={`text-3xl font-bold ${darkMode ? 'text-gray-100' : 'text-gray-900'}`}>Forgot Password?</h2>
          <p className={`${darkMode ? 'text-gray-300' : 'text-gray-600'} mt-2 text-sm`}>
        ...
        <div className={`${darkMode ? 'bg-gray-800 border-gray-600' : 'bg-white border-gray-200'} rounded-xl shadow-lg p-8 border`}>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className={`w-full flex items-center justify-center px-4 py-3 text-base font-medium rounded-lg
                ${darkMode
                  ? 'bg-gradient-to-r from-primary-500 to-primary-600 text-white hover:from-primary-600 hover:to-primary-700'
                  : 'bg-gradient-to-r from-primary-500 to-primary-600 text-white hover:from-primary-600 hover:to-primary-700'}
                focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-sm`}
            >
              {loading ? (
                <>
        ...
        <div className="mt-6 text-center">
          <p className={`text-sm ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
            ...
            <Link
              to="/login"
              className={`font-medium ${darkMode ? 'text-primary-400 hover:text-primary-300' : 'text-primary-600 hover:text-primary-500'}`}
            >
              Sign in
            </Link>
          </p>
